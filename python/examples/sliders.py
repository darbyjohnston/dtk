...
intEditSlider = dtk.IntEditSlider(context, None, vLayout)
...
vLayout = dtk.VerticalLayout(context, groupBox)
floatEditSlider = dtk.FloatEditSlider(context, None, vLayout)
...
vLayout = dtk.VerticalLayout(context, groupBox)
doubleEditSlider = dtk.DoubleEditSlider(context, None, vLayout)
