...
#include <dtkUI/MessageDialogPrivate.h>

#include <dtkUI/Divider.h>
#include <dtkUI/Spacer.h>
...
namespace dtk
{
    namespace ui
    {
        ...
        {
            IWidget::_init(context, "dtk::ui::MessageDialogWidget", parent);
        ...
        void ConfirmDialogWidget::_init(
            ...
            const std::shared_ptr<IWidget>& parent)
        {
            IWidget::_init(context, "dtk::ui::ConfirmDialogWidget", parent);
