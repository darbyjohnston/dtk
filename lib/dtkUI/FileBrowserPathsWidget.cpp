...
#include <dtkUI/FileBrowserPrivate.h>

#include <dtkUI/Bellows.h>
#include <dtkUI/ButtonGroup.h>
#include <dtkUI/DrivesModel.h>
#include <dtkUI/ListItemsWidget.h>
...
namespace dtk
{
    namespace ui
    {
        ...
        {
            IWidget::_init(context, "dtk::ui::FileBrowserPathsWidget", parent);
            DTK_P();
