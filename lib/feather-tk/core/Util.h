...
#define FEATHER_TK_NON_COPYABLE(CLASS) \
...
//! 
//! Required includes:
//! * feather_tk/core/Error.h
//! * feather_tk/core/String.h
//! * algorithm
//! * array
//! * sstream
#define FEATHER_TK_ENUM_IMPL(ENUM, ...) \
    std::vector<ENUM> get##ENUM##Enums() \
    { \
        std::vector<ENUM> out; \
    ...
    { \
        ...
        const auto i = std::find_if( \
            ...
            { \
                return feather_tk::compare(s, value, feather_tk::CaseCompare::Insensitive); \
            }); \
        if (i == labels.end()) \
        { \
