...
namespace feather_tk
{
    ...
    void ProgressWidget::_init(
        ...
        const std::shared_ptr<IWidget>& parent)
    {
        IWidget::_init(context, "feather_tk::ProgressWidget", parent);
    ...
    void ProgressDialogWidget::_init(
        ...
        const std::shared_ptr<IWidget>& parent)
    {
        IWidget::_init(context, "feather_tk::ProgressDialogWidget", parent);
    ...
    void ProgressDialog::_init(
        ...
        const std::shared_ptr<IWidget>& parent)
    {
        IDialog::_init(context, "feather_tk::ProgressDialog", parent);
        FEATHER_TK_P();
